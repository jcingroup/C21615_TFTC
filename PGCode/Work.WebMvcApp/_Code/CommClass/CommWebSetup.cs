...
namespace DotWeb.CommSetup
{
    ...
    public static class ImageFileUpParm
    {
        ...
        public static ImageUpScope List
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 1, KindName = "Def", LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){ SizeFolder=334, width=334}
                };
                return imUp;
            }
        }

        public static ImageUpScope Single
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 10, KindName = "Def", LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
        ...
        public static ImageUpScope Double
        {
            get
            {
                ImageUpScope imUp = new ImageUpScope() { KeepOriginImage = true, LimitCount = 10, KindName = "Def", LimitSize = 1024 * 1024 * 2 };
                imUp.Parm = new ImageSizeParm[] {
                    new ImageSizeParm(){SizeFolder=600, width=600 }
                };
                return imUp;
            }
        }
