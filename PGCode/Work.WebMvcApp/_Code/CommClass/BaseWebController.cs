...
namespace DotWeb
{
    ...
    public class IndexPage
    {
        ...
        public m_ActivePhoto Albums { get; set; }
    }

    public class IndexPageL
    {
        public ProcCore.Business.LogicL.m_Message[] Messages { get; set; }
        public ProcCore.Business.LogicL.m_ActivePhoto ActivePhoto { get; set; }
    }
