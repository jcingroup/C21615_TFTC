...
namespace ProcCore.Business.Logic.TablesDescriptionL
{
    ...
    {
        public Message() { N = "消息L"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
    ...
    {
        public PageContext() { N = "網頁L"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
    ...
    public class Document : TableMap<Document>
    {
        public Document() { N = "文件L"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
        public FieldModule title = new FieldModule() { M = "title", N = "標題", T = SQLValueType.String };
        public FieldModule set_date = new FieldModule() { M = "set_date", N = "日期", T = SQLValueType.DateTime };
        public FieldModule isopen = new FieldModule() { M = "isopen", N = "開放", T = SQLValueType.Boolean };
    ...
    public class ActivePhoto : TableMap<ActivePhoto>
    {
        public ActivePhoto() { N = "活動L"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
        public FieldModule title = new FieldModule() { M = "title", N = "標題", T = SQLValueType.String };
        public FieldModule set_date = new FieldModule() { M = "set_date", N = "日期", T = SQLValueType.DateTime };
        public FieldModule isopen = new FieldModule() { M = "isopen", N = "開放", T = SQLValueType.Boolean };
