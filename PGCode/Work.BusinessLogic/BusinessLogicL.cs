...
namespace ProcCore.Business.LogicL
{
    ...
    public static class CodeSheet
    {
        ...
        public static 消息分類L 消息分類L = new 消息分類L()
        {
            Active = new _Code() { Code = "Active", Value = "活動訊息" },
            Class = new _Code() { Code = "Class", Value = "課程訊息" },
            Research = new _Code() { Code = "Research", Value = "研討會訊息" }
        };
    }
    ...
    public class 消息分類L : BaseSheet
    {
        public 消息分類L() { this.CodeGroup = 1; }
        public _Code Active { get; set; }
        public _Code Class { get; set; }
        public _Code Research { get; set; }
        public override List<_Code> MakeCodes()
        {
            this.Codes = new List<_Code>(); this.Codes.AddRange(new _Code[] { this.Active, this.Class, this.Research }); return base.MakeCodes();
        }
    }
    #endregion
    //=============================================================
    ...
    public class a_Message : LogicBase<m_Message, q_Message, Message>
    {
        ...
        public override RunQueryPackage<m_Message> SearchMaster(q_Message qr, int accountId)
        {
            ...
            try
            {
                ...
                #region 設定輸出至Grid欄位
                TablePack<Message> dataWork = new TablePack<Message>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId };
                dataWork.SelectFields(x => new { x.id, x.title, x.set_date, x.isopen, x.kind,x.context });
    ...
    public class m_Document : ModuleBase
    {
        public Int32 id { get; set; }
        ///<summary>
        ///Mapping:標題
    ...
    public class a_Document : LogicBase<m_Document, q_Document, Document>
    {
        public override RunInsertEnd InsertMaster(m_Document md, int accountId)
        {
            #region Variable declare area
            RunInsertEnd r = new RunInsertEnd(); //宣告回傳物件
            #endregion
            try
            {
                #region Main working
                Connection.BeginTransaction(); //開始交易鎖定
                TablePack<Document> dataWork = new TablePack<Document>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId };
        ...
        public override RunUpdateEnd UpdateMaster(m_Document md, int accountId)
        {
            #region Variable declare area
            RunUpdateEnd r = new RunUpdateEnd();
            #endregion
            try
            {
                ...
                dataWork.TableModule.KeyFieldModules[dataWork.TableModule.id.N].V = md.id; //取得ID欄位的值
                m_Document md_Origin = dataWork.GetDataByKey<m_Document>(); //取得Key值的Data
        ...
        public override RunDeleteEnd DeleteMaster(Int32[] ids, int accountId)
        {
            ...
            try
            {
                ...
                Connection.BeginTransaction();
                //1、要刪除的資料先選出來
                TablePack<Document> dataWork = new TablePack<Document>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId }; //宣告泛型物件並連接Connection
                dataWork.SelectFields(x => x.id); //只Select 主Key欄位
                dataWork.WhereFields(x => x.id, ids); //代入陣列Id值

                m_Document[] md_Origin = dataWork.DataByAdapter<m_Document>(); //取得Key值的Data
        ...
        public override RunQueryPackage<m_Document> SearchMaster(q_Document qr, int accountId)
        {
            #region 變數宣告
            RunQueryPackage<m_Document> r = new RunQueryPackage<m_Document>();
            #endregion
            try
            {
                #region Select Data 區段 By 條件
                #region 設定輸出至Grid欄位
                TablePack<Document> dataWork = new TablePack<Document>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId };
                dataWork.SelectFields(x => new { x.id, x.title, x.set_date, x.isopen });
                ...
                #region 輸出物件陣列
                r.SearchData = dataWork.DataByAdapter<m_Document>();
                r.Result = true;
                return r;
                #endregion
                #endregion
        ...
        public override RunOneDataEnd<m_Document> GetDataMaster(int id, int accountId)
        {
            #region 變數宣告
            RunOneDataEnd<m_Document> r = new RunOneDataEnd<m_Document>();
            ...
            try
            {
                ...
                TablePack<Document> dataWork = new TablePack<Document>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId };
                dataWork.TableModule.KeyFieldModules[dataWork.TableModule.id.N].V = id; //設定KeyValue
                m_Document md = dataWork.GetDataByKey<m_Document>(); //取得Key該筆資料
    ...
    #endregion
    #region ActivePhoto
    public class q_ActivePhoto : QueryBase
    {
        public String s_title { set; get; }
        public Boolean? s_isopen { set; get; }
    }
    public class m_ActivePhoto : ModuleBase
    {
        public Int32 id { get; set; }
        ///<summary>
        ///Mapping:標題
    ...
    public class a_ActivePhoto : LogicBase<m_ActivePhoto, q_ActivePhoto, ActivePhoto>
    {
        public override RunInsertEnd InsertMaster(m_ActivePhoto md, int accountId)
        {
            #region Variable declare area
            RunInsertEnd r = new RunInsertEnd(); //宣告回傳物件
            #endregion
            try
            {
                #region Main working
                Connection.BeginTransaction(); //開始交易鎖定
                TablePack<ActivePhoto> dataWork = new TablePack<ActivePhoto>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId };
        ...
        public override RunUpdateEnd UpdateMaster(m_ActivePhoto md, int accountId)
        {
            #region Variable declare area
            RunUpdateEnd r = new RunUpdateEnd();
            #endregion
            try
            {
                ...
                dataWork.TableModule.KeyFieldModules[dataWork.TableModule.id.N].V = md.id; //取得ID欄位的值
                m_ActivePhoto md_Origin = dataWork.GetDataByKey<m_ActivePhoto>(); //取得Key值的Data
        ...
        public override RunDeleteEnd DeleteMaster(Int32[] ids, int accountId)
        {
            ...
            try
            {
                ...
                Connection.BeginTransaction();
                //1、要刪除的資料先選出來
                TablePack<ActivePhoto> dataWork = new TablePack<ActivePhoto>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId }; //宣告泛型物件並連接Connection
                dataWork.SelectFields(x => x.id); //只Select 主Key欄位
                dataWork.WhereFields(x => x.id, ids); //代入陣列Id值

                m_ActivePhoto[] md_Origin = dataWork.DataByAdapter<m_ActivePhoto>(); //取得Key值的Data
        ...
        public override RunQueryPackage<m_ActivePhoto> SearchMaster(q_ActivePhoto qr, int accountId)
        {
            #region 變數宣告
            RunQueryPackage<m_ActivePhoto> r = new RunQueryPackage<m_ActivePhoto>();
            #endregion
            try
            {
                #region Select Data 區段 By 條件
                ...
                #region 輸出物件陣列
                r.SearchData = dataWork.DataByAdapter<m_ActivePhoto>();
                r.Result = true;
                return r;
                #endregion
                #endregion
        ...
        public override RunOneDataEnd<m_ActivePhoto> GetDataMaster(int id, int accountId)
        {
            #region 變數宣告
            RunOneDataEnd<m_ActivePhoto> r = new RunOneDataEnd<m_ActivePhoto>();
            ...
            try
            {
                ...
                TablePack<ActivePhoto> dataWork = new TablePack<ActivePhoto>(Connection) { LoginUserID = this.logPlamInfo.UserId, LoginUnitID = this.logPlamInfo.UnitId };
                dataWork.TableModule.KeyFieldModules[dataWork.TableModule.id.N].V = id; //設定KeyValue
                m_ActivePhoto md = dataWork.GetDataByKey<m_ActivePhoto>(); //取得Key該筆資料
